...
pt-30 text-gray-700 dark:text-white"
    >
      <Title
        ...
        desc="From strategy to execution, we craft digital solutions that move
your business forward."
    ...
    <form className="grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full">
        ...
        <div className="sm:col-span-2"> 
            ...
            <textarea rows={8} placeholder="Enter you message" className="w-full p-3 text-sm outline-none rounded-lg border border-gray-300
